...
logs = True   #是否开启日志
log_path = "/tmp/pycharm_project_773/resnet18_冻结全连接层参数_使用自己的数据集/models/训练结果/11" + current_time  # tensorboard
save_path = "/tmp/pycharm_project_773/resnet18_冻结全连接层参数_使用自己的数据集/models/训练结果/权重存储" + current_time  # 权重存储
...
save_weitht_txt ="/tmp/pycharm_project_773/resnet18_冻结全连接层参数_使用自己的数据集/models/训练结果/文本记录" + current_time
...
#修改后的画图/////////////////////////////////////////////////////
    ax.plot(x, val_acc, color="red", label="train_acc")  # 用名字代表颜色, 'red'代表红色
    ax.plot(x, train_acc, color="b", label="val_acc")  # 颜色代码，(rgbcmyk)
#修改后的画图/////////////////////////////////////////////////////
