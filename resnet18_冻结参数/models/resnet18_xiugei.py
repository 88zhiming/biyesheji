...
use_mix = False  # 是否使用mix技术
use_cutmix = False  # 是否使用cutmixj
use_mixup = False  # 是否使用mixup
alpha = 0.5  # mixup的融合系数。
cutmix_alpha = 0.5
...
logs = True   #是否开启日志
log_path = "/tmp/pycharm_project_773/148/11" + current_time  # tensorboard
save_path = "/tmp/pycharm_project_773/148/权重存储" + current_time  # 权重存储
...
save_weitht_txt =  "/tmp/pycharm_project_773/148/文本记录" + current_time
