...
log_path = "/tmp/pycharm_project_773/vgg16模型复制/models/训练结果/tensorboard" + current_time  # tensorboard
save_path = "/tmp/pycharm_project_773/vgg16模型复制/models/训练结果/权重存储" + current_time  # 权重存储
...
save_weitht_txt =  "/tmp/pycharm_project_773/vgg16模型复制/models/训练结果/文本记录" + current_time  #文本记录训练过程
