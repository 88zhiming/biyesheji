...
logs = True  #
# 是否开启日志
log_path = "/tmp/pycharm_project_773/test/特征融合训练结果/tensorboard" + current_time  # tensorboard
save_path = "/tmp/pycharm_project_773/test/特征融合训练结果/权重存储" + current_time  # 权重存储
...
save_weight_txt = "/tmp/pycharm_project_773/test/特征融合训练结果/文本记录" + current_time  # 文本记录训练过程
