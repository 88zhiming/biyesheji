...
logs = True  #
# 是否开启日志
log_path = "/tmp/pycharm_project_773/shufflenet网络特征融合/训练结果/tensorboard" + current_time  # tensorboard
save_path = "/tmp/pycharm_project_773/shufflenet网络特征融合/训练结果/权重存储" + current_time  # 权重存储
model_weight_path  = "/tmp/pycharm_project_773/shufflenet网络特征融合/训练结果/resnet18-pre.pth"
# 输入图像文件夹
image_path ="/home/amax/YSPACK/NEW_DATA_NOTSPIT_GENGXIN/"
save_weight_txt = "/tmp/pycharm_project_773/shufflenet网络特征融合/训练结果/文本记录" + current_time  # 文本记录训练过程
