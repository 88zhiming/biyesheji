...
log_path = "/tmp/pycharm_project_773/resnet18_使用自己的数据集/models/训练结果/Tensorboard" + current_time  # tensorboard
save_path = "/tmp/pycharm_project_773/resnet18_使用自己的数据集/models/训练结果/权重存储" + current_time  # 权重存储
...
save_weitht_txt =  "/tmp/pycharm_project_773/resnet18_使用自己的数据集/models/训练结果/文本记录过程" + current_time  #文本记录训练过程
