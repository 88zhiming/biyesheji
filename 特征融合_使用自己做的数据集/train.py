...
logs = True  #
# 是否开启日志
log_path = "/tmp/pycharm_project_773/resnet18_冻结参数_使用自己的数据集/models/训练结果/tensorboard" + current_time  # tensorboard
save_path = "/tmp/pycharm_project_773/resnet18_冻结参数_使用自己的数据集/models/训练结果/权重存储" + current_time  # 权重存储
model_weight_path  = "/home/amax/fgq/Graduation project/cnn/pre-weights/resnet18-pre.pth"
# 输入图像文件夹
image_path ="/home/amax/YSPACK/NEW_DATA_NOTSPIT_GENGXIN/"
save_weight_txt = "/tmp/pycharm_project_773/resnet18_冻结参数_使用自己的数据集/models/训练结果/文本记录" + current_time  # 文本记录训练过程
