...
log_path = "/tmp/pycharm_project_773/121/训练结果保存" + current_time  # tensorboard
save_path = "/tmp/pycharm_project_773/121/权重存储" + current_time  # 权重存储
...
save_weitht_txt =  "/tmp/pycharm_project_773/121/文本记录过程" + current_time  #文本记录训练过程
